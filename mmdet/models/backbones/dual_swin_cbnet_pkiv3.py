...
class Dual_SwinTransformer_CBPkiv3(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(Dual_SwinTransformer_CBPkiv3, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(Dual_SwinTransformer_CBPkiv3, self).train(mode)
        self._freeze_stages()
