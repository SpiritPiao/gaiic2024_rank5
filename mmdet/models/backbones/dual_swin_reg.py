...
class Dual_SwinTransformer_Reg(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        self.reg_net_256 = Unet(4 * 2)
        input_size = 1024
        self.spt_256 = SpatialTransformer(size=(input_size // 4, input_size // 4))
        self.spt_128 = SpatialTransformer(size=(input_size // 8, input_size // 8))
        self.spt_64 = SpatialTransformer(size=(input_size // 16, input_size // 16))
        self.spt_32 = SpatialTransformer(size=(input_size // 32, input_size // 32))
