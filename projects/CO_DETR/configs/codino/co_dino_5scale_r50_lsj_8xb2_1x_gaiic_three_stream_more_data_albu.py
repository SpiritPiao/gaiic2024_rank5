...
custom_imports = dict(imports=['projects.CO_DETR.codetr.codetr_three_stream',
...
model = dict(
    ...
    data_preprocessor=dict(
        type='ThreeInputDetDataPreprocessor',
...
test_pipeline = [
    ...
    dict(
        type='ThreePackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape', 'img_path2', 'ori_shape2', 'img_shape2', 'img_path3', 'ori_shape3', 'img_shape3',
                   'scale_factor'))
]
