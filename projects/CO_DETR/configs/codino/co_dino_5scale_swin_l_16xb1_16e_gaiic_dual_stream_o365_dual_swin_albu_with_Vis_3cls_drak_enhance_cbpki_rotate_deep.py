_base_ = ['co_dino_5scale_r50_lsj_8xb2_1x_gaiic_dual_stream_more_data_albu_with_Vis_3cls_dark_enhance_rotate_pki_deep.py']
...
model = dict(
    ...
    backbone=dict(
        _delete_=True,
        type='Dual_SwinTransformer_CBPki_Deep',
