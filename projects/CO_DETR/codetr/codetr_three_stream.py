...
class CoDETR_Three(BaseDetector):
    ...
    def __init__(
        ...
        super(CoDETR_Three, self).__init__(
    ...
    def forward(self,
            ...
            if mode == 'loss':
                return self.loss(inputs, inputs2, inputs3, data_samples)
            elif mode == 'predict':
                return self.predict(inputs, inputs2,inputs3, data_samples)
            elif mode == 'tensor':
                return self._forward(inputs, inputs2,inputs3, data_samples)
            else:
    ...
    def extract_feat(self, batch_inputs: Tensor, batch_inputs2: Tensor, batch_inputs3: Tensor) -> Tuple[Tensor]:
        """Extract features.
        ...
        x_y = list(self.backbone3(batch_inputs3))
        # z = x
        
        z = [i + j + k for i, j, k in zip(x, y, x_y)]
    ...
    def loss(self, batch_inputs: Tensor, batch_inputs2: Tensor, batch_inputs3: Tensor,
        ...
        x = self.extract_feat(batch_inputs, batch_inputs2, batch_inputs3)
    ...
    def predict(self,
                batch_inputs: Tensor, batch_inputs2: Tensor, batch_inputs3: Tensor,
        ...
        img_feats = self.extract_feat(batch_inputs, batch_inputs2, batch_inputs3)
